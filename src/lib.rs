...
use nusb::{
    ...
    GetDescriptorError, MaybeFuture,
};
use thiserror::Error;
...
pub enum Error {
    ...
    #[error(transparent)]
    GetDescriptor(#[from] GetDescriptorError),
    #[error(transparent)]
...
impl DfuIo for DfuNusb {
    ...
    fn write_control(
        ...
        self.interface
            ...
            .wait()?;
        Ok(buffer.len()) // TODO: Can we know the actual len submitted?
    }
...
impl DfuAsyncIo for DfuNusb {
    ...
    async fn write_control(
        ...
        self.interface
            .control_out(req, Duration::from_secs(3))
            .await?;
        Ok(buffer.len()) // TODO: How to know the actual length submitted?
    }
